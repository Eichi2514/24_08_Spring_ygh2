...
public class UsrReplyController {
	...
	@ResponseBody
	public String doDelete(HttpServletRequest req, int id, int articleId) {
		Rq rq = (Rq) req.getAttribute("rq");
		...
		return Ut.jsReplace(loginedMemberCanDeleteRd.getResultCode(), loginedMemberCanDeleteRd.getMsg(), "../article/detail?id=" + articleId);
	}
